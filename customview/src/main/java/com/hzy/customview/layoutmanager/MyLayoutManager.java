    ...
    private void calculateChildrenSite(RecyclerView.Recycler recycler) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            if (needNew) {
                ...
                measureChildWithMargins(view, getScreenWidth() / 2, 0);
            ...
            if (i % 2 == 0) { // 当i能被2整除时，是左，否则是右。
                // 左
                mTmpRect.set(0, totalHeight, getScreenWidth() / 2, totalHeight + height);
            } else {
                // 右，需要换行
                mTmpRect.set(getScreenWidth() / 2, totalHeight, getScreenWidth(),
                        totalHeight + height);
    ...
    private void recycleAndFillView(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            if (Rect.intersects(displayRect, allItemRects.get(i))) {
                ...
                measureChildWithMargins(itemView, getScreenWidth() / 2, 0);
